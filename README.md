# [@powergate @powergate](https://telegram.me/AntiSpam_@powergate)

**An advanced and powerful administration bot based on [yagop/telegram-bot](https://github.com/yagop/telegram-bot) licensed under the [GNU General Public License](https://github.com/hafez16/mega-@powergate/blob/supergroups/LICENSE)**.
...
## Commands
@powergate-@powergate has several commands that are only usable at certain ranks.
...
| [#!/]@powergate| Returns bot information. |
...
cd $HOME
git clone https://github.com/hafez16/mega-@powergate.git
cd mega-@powergate
chmod +x launch.sh
./launch.sh install
